...
<div class="flex flex-col md:flex-row justify-between items-start w-full h-auto max-w-6xl bg-black rounded-2xl px-8 md:px-8 py-8 md:py-20">
    <h1 class="font-black text-5xl md:text-4xl text-white w-full pb-8 md:pb-0"> Can Used On </h1>
    <div class="grid grid-cols-4 md:grid-cols-3 gap-2 md:gap-4 w-full h-auto">
      <div class="col-span-2 md:col-span-1 w-full h-auto rounded-xl">
        <div class="flex flex-col justify-start items-center w-full md:w-40 h-40 p-4 rounded-xl shadow-xl bg-white relative">
          <div class="absolute inset-0 flex flex-col justify-between w-auto h-auto p-3 text-left">
