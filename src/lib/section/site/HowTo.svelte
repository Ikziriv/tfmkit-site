...
<div class="flex flex-col justify-center items-start w-full h-auto md:h-auto max-w-6xl bg-black rounded-b-2xl px-8 md:px-8 py-8 md:py-20">
    <h1 class="font-black text-white text-5xl md:text-4xl pb-8 md:pb-8"> How to Use </h1>
    <div class="grid grid-cols-12 gap-4 md:gap-4 w-full h-auto">
      ...
      <div class="col-span-full md:col-span-4 w-full h-screen rounded-xl">
        <div class="flex flex-col justify-start items-center w-full h-screen p-4 rounded-xl shadow-xl bg-white relative">
          <div class="flex flex-col w-auto h-auto px-4 md:px-8 text-left">
            ...
            <p class="font-normal leading-none">Magic form for your campaign</p>
          </div>
