...
<div class="flex flex-col md:flex-row justify-center items-start w-full h-auto md:h-screen max-w-6xl bg-white px-8 md:px-8 py-8 md:py-20">
    <h1 class="font-black text-5xl md:text-4xl pb-8 md:pb-0"> How to Use </h1>
